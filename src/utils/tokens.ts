...
// most once, so every attempt (including client resends and server retries)
// for the same order must present the same key. Never mix in time or
// randomness here, or retries will look like distinct charges.
